                        ...
                        <table id="datatablesSimple">
                            ...
                            <c:forEach items="${admins}" var="admin">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<c:url value="/admin/admins/add"/>">Dodaj</a>
                                         |
                                        <a href="<c:url value="/admin/admins/edit/${admin.id}"/>">Edytuj</a>
                                        |
                                        <a href="<c:url value="/admin/admins/delete/${admin.id}"/>">Usuń</a>
                                    </td>
                                </tr>
                                </tbody>
                            </c:forEach>
