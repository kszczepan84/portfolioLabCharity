    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Administratorzy</h1>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form:form method="post" modelAttribute="user" action="/admin/admins/edit" >
                            <form:hidden path="id" value="${id}"/>
                            <table>
                                <thead>
                                <tr>
                                    <th>Imię</th>
                                    <td><form:input path="firstName" type="text" value="${firstName}"/></td>
                                </tr>
                                <tr>
                                    <th>Nazwisko</th>
                                    <td><form:input path="lastName" type="text" value="${lastName}"/></td>
                                </tr>
                                <tr>
                                    <th>Email</th>
                                    <td><form:input path="email" type="text" value="${email}"/></td>
                                </tr>
                                <tr>
                                    <th>Hasło</th>
                                    <td><form:input path="password" type="text" value="${password}"/></td>
                                </tr>
                                <tr>
                                    <th><form:button type="submit">Zatwierdź</form:button></th>
                                </tr>
                                </thead>
                            </table>
                        </form:form>
