...
<%--                            <td>--%>
<%--                                <a href="<c:url value="/admin/institution/edit/${institution.id}"/>" class="edit" title="Edit"--%>
<%--                                   data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>--%>
<%--                                <a href="<c:url value="/admin/institution/delete/${institution.id}"/>" class="delete" title="Delete"--%>
<%--                                   data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>--%>
<%--                            </td>--%>
<%--                        </tr>--%>
<%--                        </tbody>--%>
