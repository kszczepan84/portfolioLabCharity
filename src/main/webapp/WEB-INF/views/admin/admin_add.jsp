                    ...
                    <div class="card-body">
                        <form:form method="post" modelAttribute="user" >
                            <table>
                                ...
                                <tr>
                                    <th>Imię</th>
                                    <td><form:input path="firstName" type="text" placeholder="Imię"/></td>
                                </tr>
                                <tr>
                                    <th>Nazwisko</th>
                                    <td><form:input path="lastName" type="text" placeholder="Nazwisko"/></td>
                                </tr>
                                <tr>
                                    <th>Email</th>
                                ...
                                <tr>
                                    <th>Hasło</th>
                                    <td><form:input path="password" type="text" placeholder="Hasło"/></td>
                                </tr>
                                <tr>
